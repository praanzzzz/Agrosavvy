# Generated by Django 5.1.4 on 2024-12-24 06:02
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('gender', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='app_agrosavvy.gender')),
                ('roleuser', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='app_agrosavvy.roleuser')),
                ('useraddress', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='app_agrosavvy.useraddress')),
            ],
            options={
